...
export const inputClassName =
  "w-full rounded-xl bg-[var(--bg-surface)] dark:bg-navy-900/60 border border-[var(--border-subtle)] dark:border-white/20 px-4 py-3 h-12 text-sm text-[var(--text-primary)] placeholder:text-[var(--text-secondary)] dark:placeholder:text-slate-400 focus:border-[var(--accent-yellow)] focus:ring-1 focus:ring-[var(--accent-yellow)] outline-none transition-all";
...
export const labelClassName =
  "block text-sm font-medium tracking-wide text-[var(--text-primary)] dark:text-slate-300 mb-2";
...
export const submitButtonClassName =
  "inline-flex h-12 w-full items-center justify-center gap-2 rounded-full bg-[var(--accent-yellow)] px-6 text-sm font-bold text-[var(--brand-navy)] dark:text-slate-900 transition-all hover:bg-[var(--accent-yellow-hover)] hover:scale-[1.02] hover:shadow-2xl disabled:opacity-60 disabled:cursor-not-allowed sm:h-14 sm:px-8 sm:text-base sm:w-auto";
